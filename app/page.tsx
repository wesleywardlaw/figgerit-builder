    ...
    <div className="min-h-screen py-10 px-6 md:px-20">
      <section className="mb-12 bg-gray-800 shadow-xl rounded-2xl p-6">
        ...
        <p className="text-white mb-2">
          Add riddles and sayings to be used in generating your Figgerit
          puzzles. Optionally associate riddles and sayings with a category.
          Supports uploading via CSV files.
        </p>
      </section>
